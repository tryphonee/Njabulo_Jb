...
const fetchGitHubStats = async () => {
    try {
        const response = await axios.get("https://api.github.com/repos/NjabuloJ/VW-GOLF");
...
fana({ nomCom: "list", aliases: ["liste", "helplist", "commandlist"], categorie: "system" }, async (message, client, config) => {
