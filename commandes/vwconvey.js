...
fana({nomCom:"ss",categorie: "Conversion", reaction: "❤️"},async(origineMessage,zk,commandeOptions)=>{
...
fana({nomCom:"croping",categorie: "Conversion", reaction: "♻️"},async(origineMessage,zk,commandeOptions)=>{
...
fana({nomCom:"getstickers",categorie: "Conversion", reaction: "😜"},async(origineMessage,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
fana({ nomCom: "words", categorie: "Conversion", reaction: "😂" }, async (origineMessage, zk, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
...
fana({nomCom:"picture1",categorie: "Conversion", reaction: "💀"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
fana({ nomCom: "trt", categorie: "Conversion", reaction: "⌛" }, async (dest, zk, commandeOptions) => {
