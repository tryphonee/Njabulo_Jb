...
fana({nomCom:"sticker",categorie: "Use", reaction: "👨🏿‍💻"},async(origineMessage,zk,commandeOptions)=>{
...
fana({nomCom:"scrop",categorie: "Use", reaction: "☘️"},async(origineMessage,zk,commandeOptions)=>{
...
zokou({nomCom:"take",categorie: "Use", reaction: "💗"},async(origineMessage,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
fana({ nomCom: "write", categorie: "Use", reaction: "☘️" }, async (origineMessage, zk, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
...
fana({nomCom:"photo",categorie: "Use", reaction: "☘️"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
fana({ nomCom: "trt", categorie: "Use", reaction: "💗" }, async (dest, zk, commandeOptions) => {
